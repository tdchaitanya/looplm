...
class TestConfigManager:
    ...
    def test_init(self, mock_config_dir):
        ...
        with patch.object(ConfigManager, "_init_encryption"), \
    ...
    def test_get_configured_providers(self, config_manager):
        ...
        assert providers[ProviderType.ANTHROPIC]["default_model"] == "claude-3-opus-20240229"
    ...
    def test_save_provider_config(self, config_manager):
        ...
        assert config["providers"]["anthropic"]["default_model"] == "claude-3-opus-20240229"
    ...
    def test_reset_provider(self, config_manager, monkeypatch):
        ...
        assert config["default_provider"] == "openai"  # Should fall back to another provider
