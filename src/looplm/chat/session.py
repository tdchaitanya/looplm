...
class ChatSession:
    ...
    def send_message(self, content: str, stream: bool = True, show_tokens: bool = False) -> str:
        ...
        try:
            ...
            if stream:
                response_text = self._handle_streaming_response(actual_model, messages, show_tokens)
    ...
    def _handle_streaming_response(self, model: str, messages: List[Dict], show_tokens: bool = False) -> str:
    ...
    def _handle_normal_response(self, model: str, messages: List[Dict], show_tokens: bool = False) -> str:
